proc create_ipi_design { offsetfile design_name } {
	...
	set Sub_Bytes_0 [ create_bd_cell -type ip -vlnv sfu.ca:user:Sub_Bytes:0.5 Sub_Bytes_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores sfu.ca:user:Sub_Bytes:0.5]]]]
