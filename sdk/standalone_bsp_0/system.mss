...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles -Wall -Wextra -g -O0
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = SW_LED_GPIO_AXI
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.4
...
BEGIN DRIVER
 ...
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = AMA142_OLED_AXI
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = BTN_GPIO_AXI
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = AES_Full
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = AES_Full_0
END
