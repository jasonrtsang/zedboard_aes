...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles -Wall -Wextra -g3 -O0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = Key_Expansion
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Key_Expansion_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = Add_Round_Key
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Add_Round_Key_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = SW0_AXI_GPIO
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = Shift_Rows
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Shift_Rows_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = Sub_Bytes
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Sub_Bytes_0
END
