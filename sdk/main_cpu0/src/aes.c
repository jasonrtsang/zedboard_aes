...
* 			enum AESMODE mode         : Encryption or decryption
*
...
**/
/*****************************************************************************/
enum STATUS _aes_ecb_run(uint32_t *inputBuf, uint32_t *outputBuf, int fileSize)
{
	int i;
...
*
* @param    enum AESMODE mode         : ECB or CBC cipher type
* 			enum AESMODE mode         : Encryption or decryption
*
* @return   enum STATUS
*
