...
#
# Generated by Vivado on Mon Mar 12 22:50:04 -0700 2018
...
proc cr_bd_system { parentCell } {
  ...
  # Create instance: AES_ECB_AXIS_0, and set properties
  set AES_ECB_AXIS_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AES_ECB_AXIS:1.0 AES_ECB_AXIS_0 ]
  ...
  connect_bd_intf_net -intf_net AES_ECB_AXIS_0_M_AXIS [get_bd_intf_pins AES_ECB_AXIS_0/M_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins AES_ECB_AXIS_0/S_AXIS] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
