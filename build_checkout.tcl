...
#
# build_checkout.tcl: Tcl script for re-creating project 'zedboard_aes'
#
# Generated by Vivado on Mon Mar 12 18:31:14 -0700 2018
...
#
# 1. This project restoration tcl script (build_checkout.tcl) that was generated.
#
...
set script_file "build_checkout.tcl"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/ip_repo/Shift_Rows_0.5"] [file normalize "$origin_dir/ip_repo/Sub_Bytes_0.5"] [file normalize "$origin_dir/ip_repo/ECB_1.0"] [file normalize "$origin_dir/ip_repo/Add_Round_Key_0.5"] [file normalize "$origin_dir/ip_repo/Key_Expansion_0.5"]" $obj
...
proc cr_bd_system { parentCell } {
  ...
  # Create instance: ECB_v1_0_0, and set properties
  set ECB_v1_0_0 [ create_bd_cell -type ip -vlnv sfu.ca:user:ECB_v1_0:1.0 ECB_v1_0_0 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /ECB_v1_0_0/s00_axi]
  ...
  connect_bd_intf_net -intf_net ECB_v1_0_0_M_AXIS [get_bd_intf_pins ECB_v1_0_0/M_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins ECB_v1_0_0/S_AXIS] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ECB_v1_0_0/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ECB_v1_0_0/s00_axi/reg0] SEG_ECB_v1_0_0_reg0
