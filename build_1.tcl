...
#
# build_1.tcl: Tcl script for re-creating project 'zedboard_aes'
#
# Generated by Vivado on Thu Feb 22 23:24:17 -0800 2018
...
#
# 1. This project restoration tcl script (build_1.tcl) that was generated.
#
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/ip_repo/Key_Expansion_0.5"]" $obj
...
proc cr_bd_system { parentCell } {
  ...
  # Create instance: Key_Expansion_1, and set properties
  set Key_Expansion_1 [ create_bd_cell -type ip -vlnv sfu.ca:user:Key_Expansion:0.5 Key_Expansion_1 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins Key_Expansion_1/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]

  # Create port connections
  connect_bd_net -net SW0_1 [get_bd_ports SW0] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Key_Expansion_0/s00_axi_aclk] [get_bd_pins Key_Expansion_1/s00_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins Key_Expansion_0/s00_axi_aresetn] [get_bd_pins Key_Expansion_1/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Key_Expansion_1/S00_AXI/S00_AXI_reg] SEG_Key_Expansion_1_S00_AXI_reg
